...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 22 mai 2023 à 10:00
...
INSERT INTO `compter` (`id_secteur`, `id_entreprise`) VALUES
(115, 5343),
(110, 10863),
(109, 11016),
(196, 11017),
...
CREATE TABLE IF NOT EXISTS `entreprise` (
  ...
  `adresse_entreprise` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
(11138, 'SCI DEAUMAT', '0682562481', '3 Rue Pierre et Marie Curie, Saint-Léger-de-Linière, France', 'Location de bureaux', 'Bureaux avec parking privé et climatisation, \r\nsurfaces disponibles de 13 m² a 73 m².\r\nPossibilité de domiciliation', NULL, NULL, 0, 0, '47.463510', '-0.664116', 176),
...
(11750, 'Steph’Fabrik', NULL, '12 Rue des Rabières, 49140 Seiches-sur-le-Loir, France', 'Créations d\'objets, gravure personnalisée', 'Créations d’objets personnalisés pour évènements, cadeaux et publicités.\r\nGravure pour objets public', 'https://www.stephfabrik.fr/', 'https://www.facebook.com/StephFabrik/, https://www.instagram.com/stephfabrik/', 0, 1, '47.577279', '-0.357548', 176),
...
--
-- Contraintes pour la table `compter`
--
ALTER TABLE `compter`
  ADD CONSTRAINT `compter_ibfk_1` FOREIGN KEY (`id_secteur`) REFERENCES `secteur` (`id_secteur`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `compter_ibfk_2` FOREIGN KEY (`id_entreprise`) REFERENCES `entreprise` (`id_entreprise`) ON DELETE CASCADE ON UPDATE RESTRICT;
